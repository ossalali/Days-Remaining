...
internal fun EventListScreen(
    ...
    EventListImpl(
        ...
        onUnarchiveEvents = { eventItems -> viewModel.unarchiveEvents(eventItems.map { it.id }) },
        onArchiveEventItems = { eventItems -> viewModel.archiveEvents(eventItems.map { it.id }) },
